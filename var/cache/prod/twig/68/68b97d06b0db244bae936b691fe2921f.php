...
class __TwigTemplate_5e84e84142036b149beb2d4aa25b7055 extends Template
{
        ...
        <tbody>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                ...
                foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                    // line 15
                    yield "                    <td>";
                    yield $this->env->getFilter('escape')->getCallable()($this->env, Twig\Extension\CoreExtension::replace($context["item"], ["," => ", "]), "html", null, true);
                    yield "</td>
                ";
                }
                $_parent = $context['_parent'];
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                // line 25
                yield $this->env->getFilter('escape')->getCallable()($this->env, Twig\Extension\CoreExtension::first($this->env->getCharset(), $context["row"]), "html", null, true);
                yield "
";
            }
            $_parent = $context['_parent'];
...
";
    ...
    {
        return new Source("", "@Doctrine/Collector/explain.html.twig", "/var/www/html/contao-live/vendor/doctrine/doctrine-bundle/templates/Collector/explain.html.twig");
    }
}
