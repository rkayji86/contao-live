...
class getContao_Migration_CollectionService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/madeyourday/contao-rocksolid-custom-elements/src/Migration/BasicEntitiesMigration.php';
