...
class getContao_Filesystem_VirtualFactoryService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->mount(new \League\Flysystem\Local\LocalFilesystemAdapter((\dirname(__DIR__, 3).'/nc_bulky_items'), \League\Flysystem\UnixVisibility\PortableVisibilityConverter::fromArray(['file' => ['public' => 420, 'private' => 384], 'dir' => ['public' => 493, 'private' => 448]], 'private'), 0, 1, NULL, false), 'notification_center/bulky_items');
