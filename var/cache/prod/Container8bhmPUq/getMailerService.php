...
class getMailerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->services['contao.mailer.available_transports'] ?? $container->load('getContao_Mailer_AvailableTransportsService'));
        ...
        }, 4)))->fromStrings(['main' => $container->getEnv('MAILER_DSN')]), NULL, $a), $b, ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), $c);
    }
}
