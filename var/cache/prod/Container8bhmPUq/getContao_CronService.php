...
class getContao_CronService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/terminal42/notification_center/src/Cron/PruneBulkyItemStorageCron.php';
        ...
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob(new \Terminal42\NotificationCenterBundle\Cron\PruneBulkyItemStorageCron(($container->privates['Terminal42\\NotificationCenterBundle\\BulkyItem\\BulkyItemStorage'] ?? $container->load('getBulkyItemStorageService'))), '@daily', NULL, 'Terminal42\\NotificationCenterBundle\\Cron\\PruneBulkyItemStorageCron'));
