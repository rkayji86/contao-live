...
class getContao_Command_DebugFragmentsService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add('contao.frontend_module.lostPasswordNotificationCenter', ($container->privates['contao.fragment._config_iDtc0BM'] ?? ($container->privates['contao.fragment._config_iDtc0BM'] = new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.lostPasswordNotificationCenter', 'forward', ['ignore_errors' => false]))), ['type' => 'lostPasswordNotificationCenter', 'category' => 'user', 'template' => 'mod_lostPassword', 'method' => NULL, 'renderer' => NULL, 'debugController' => 'Terminal42\\NotificationCenterBundle\\Controller\\FrontendModule\\LostPasswordController']);
        $instance->add('contao.frontend_module.registrationNotificationCenter', ($container->privates['contao.fragment._config_0CXjiz2'] ?? ($container->privates['contao.fragment._config_0CXjiz2'] = new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.registrationNotificationCenter', 'forward', ['ignore_errors' => false]))), ['type' => 'registrationNotificationCenter', 'category' => 'user', 'template' => 'member_default', 'method' => NULL, 'renderer' => NULL, 'debugController' => 'Terminal42\\NotificationCenterBundle\\Controller\\FrontendModule\\RegistrationController']);
